...
public struct Swime {
  ...
  public func mimeType() -> MimeType? {
    ...
    if (((bytes[0] == 0x49 && bytes[1] == 0x49 && bytes[2] == 0x2A && bytes[3] == 0x0) || (bytes[0] == 0x4D && bytes[1] == 0x4D && bytes[2] == 0x0 && bytes[3] == 0x2A)) && bytes[8] == 0x43 && bytes[9] == 0x52) {
      return MimeType(
        ext: "cr2",
    ...
    /* if (bytes[0] == 0x1A && bytes[1] == 0x45 && bytes[2] == 0xDF && bytes[3] == 0xA3) { */
      /* const sliced = bytes.subarray(4, 4 + 4096); */
